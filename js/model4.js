$(function () {
    ...
    function sliderPane() {
        ...
        function slide() {
            var sliderCtx = $('#team-slider4');
            var slider = sliderCtx.find('.slider4');
            var sliderWidth = slider.width();
            var slideWidth = sliderWidth / 2;

            var arrLeft = $('.slider-controls4 .control-left');
            var arrRight = $('.slider-controls4 .control-right');
            ...
            function colorBullets() {
                ...
                $('.team-slider4 a').on('click', function () {
