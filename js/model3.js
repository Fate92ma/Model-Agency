$(function () {
    ...
    function sliderPane() {
        ...
        function slide() {
            var sliderCtx = $('#team-slider3');
            var slider = sliderCtx.find('.slider3');
            var sliderWidth = slider.width();
            var slideWidth = sliderWidth / 2;

            var arrLeft = $('.slider-controls3 .control-left');
            var arrRight = $('.slider-controls3 .control-right');
            ...
            function colorBullets() {
                ...
                $('.team-slider3 a').on('click', function () {
